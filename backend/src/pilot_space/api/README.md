...
**Parent**: `/backend/README.md` | **Base Path**: `/api/v1/`
...
| Module | Doc | Covers |
|--------|-----|--------|
| **Router Details** | [`v1/README.md`](v1/README.md) | All 20 router endpoints, middleware deep-dives, common patterns, API conventions |
...
See [`v1/README.md`](v1/README.md) for individual endpoint tables.
...
- **Router Details (all 20 routers)**: [`v1/README.md`](v1/README.md)
- **Backend Architecture**: `/backend/README.md`
- **Application Services**: [`../application/README.md`](../application/README.md)
- **Infrastructure/Repos**: [`../infrastructure/README.md`](../infrastructure/README.md)
