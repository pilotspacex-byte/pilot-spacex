...
class GhostTextAgent(StreamingSDKBaseAgent[GhostTextInput, str], ClaudeAgentMixin):
    ...
    async def stream(
        ...
        try:
            ...
            # Use SDK for streaming with timeout
            ...
            async with asyncio.timeout(timeout_seconds):
                # Stream text from SDK
                async for chunk in self.sdk_stream_text(user_prompt, context, options):
                    yield chunk
