...
class DocGeneratorAgent(SDKBaseAgent[DocGeneratorInput, DocGeneratorOutput], ClaudeAgentMixin):
    ...
    async def execute(
        ...
        Raises:
            ValueError: If doc_type is missing.
        """
        # Validate input
        ...
        content = await self.sdk_execute(prompt, context, options)
