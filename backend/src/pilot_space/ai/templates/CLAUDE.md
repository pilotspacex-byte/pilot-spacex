...
- `write_to_note(note_id, content_markdown)`: Write full note content, replacing all existing content. Use this for comprehensive rewrites or when creating note content from scratch. Returns note metadata and updated block IDs.
