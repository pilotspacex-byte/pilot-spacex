...
See [infrastructure/auth/CLAUDE.md](../../infrastructure/auth/CLAUDE.md) for full RLS architecture.
...
- **RLS Security**: [infrastructure/auth/CLAUDE.md](../../infrastructure/auth/CLAUDE.md)
