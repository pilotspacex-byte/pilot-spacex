...
**Parent**: `/backend/CLAUDE.md` | **Language**: Python 3.12+

---

## Submodule Documentation

- **[agents/CLAUDE.md](agents/CLAUDE.md)** -- PilotSpaceAgent orchestrator, subagents, session management, approval workflow, message transformation
- **[mcp/CLAUDE.md](mcp/CLAUDE.md)** -- MCP Tools (33 tools, 6 servers), Skills (8 YAML auto-discovery), Role Skill Templates (8 roles)
- **[providers/CLAUDE.md](providers/CLAUDE.md)** -- Provider Routing (DD-011, 20 task types), Resilience (retry + circuit breaker), Cost tracking
