...
**For parent layer overview, see [application/CLAUDE.md](../CLAUDE.md)**
...
- **Parent layer**: [application/CLAUDE.md](../CLAUDE.md) (CQRS-lite pattern, DI, error handling, transaction boundaries)
