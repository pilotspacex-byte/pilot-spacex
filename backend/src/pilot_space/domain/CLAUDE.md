...
- **[models/CLAUDE.md](models/CLAUDE.md)** -- All 12 entity deep-dives: Issue (state machine, fields, relationships, indexes), Note (TipTap content), State (groups, defaults), Cycle (status lifecycle), Module, Activity (32 types), NoteAnnotation, NoteIssueLink, WorkspaceOnboarding
...
- **Infrastructure models**: [infrastructure/database/CLAUDE.md](../infrastructure/database/CLAUDE.md)
