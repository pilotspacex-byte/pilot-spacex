...
- **[github/README.md](github/README.md)** -- GitHubClient (14 async API methods), GitHubWebhookHandler (HMAC-SHA256), GitHubSyncService (commit/PR linking), Service Layer (4 services), API Endpoints (11 total)
...
- **GitHub deep-dive**: [github/README.md](github/README.md)
