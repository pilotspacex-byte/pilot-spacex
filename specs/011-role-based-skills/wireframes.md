...
**Trigger**: Clicking "Set Up Your Role" item in onboarding checklist (parallel checklist — completable in any order)
**States**: Default | With Default Role | With Owner Hint | Multi-select | Custom Role

> **Note**: The onboarding is a parallel checklist (Dialog with all steps visible), not a sequential wizard. Users can complete steps in any order. The "Set Up Role" step opens a sub-flow (role selection → skill generation) within the same Dialog.

### 1A. Default State — No Pre-selections

```
┌─────────────────────────────────────────────────────────────────┐
│  Set Up Your Role                                     [Skip →] │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│   🎯  Set Up Your Role                                         │
│                                                                 │
...
│                                           124 / 5000 characters │
│                                                                 │
│   Your role name will be auto-generated by AI from              │
│   this description. You can edit it after generation.           │
│                                                                 │
│                         [ ✨ Generate Skill → ]                  │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
...
> **Change from previous version**: Removed manual "Role Name" input field. For custom roles, the user only describes their role — AI generates both the role name and skill content in one step. This skips the separate "Skill Generation Wizard" path selection since description is already provided.
...
│   We'll also generate a personalized role name from this.       │
│                                                                 │
│   ┌─────────────────────────────────────────────────┐          │
...
### 2D. Preview — Generated Skill with Auto-Generated Role Name
...
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│   ✅  Your Skill                               Generated by AI  │
│                                                                 │
│   Role Name (auto-generated — click to edit)                    │
│   ┌─────────────────────────────────────────────────┐          │
│   │ Senior Full-Stack TypeScript Developer       ✏️  │          │
│   └─────────────────────────────────────────────────┘          │
│                                                                 │
│   ┌─────────────────────────────────────────────────┐          │
...
**Preview Specs**:
- **Role name field**: Editable inline input, pre-filled with AI-generated `suggested_role_name`. Geist 16px semibold. `--background` bg, `1px solid --border`, `✏️` edit icon on right. Focus state: `--primary` border.
...
- The skill content heading (`# Senior Full-Stack TypeScript Developer`) auto-updates when the user edits the role name field
...
**Route**: `/{workspaceSlug}` (Dialog modal, parallel checklist — steps completable in any order)
**Context**: Existing checklist component updated from 3 to 4 steps. Not a sequential wizard.
...
│                                   │
│  Note: Steps completable in any   │
│  order. Progress = completed / 4. │
│                                   │
├───────────────────────────────────┤
│           [ Dismiss checklist ]   │
└───────────────────────────────────┘
