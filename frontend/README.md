# Pilot Space Frontend

AI-Augmented SDLC Platform - Frontend Application
...
**Full structure and feature modules**: See [`src/features/README.md`](src/features/README.md)
...
**Full store architecture, patterns, and anti-patterns**: See [`src/stores/README.md`](src/stores/README.md)
...
**Full extension catalog and editor setup**: See [`src/features/notes/README.md`](src/features/notes/README.md)
...
**Full API client patterns and query key factories**: See [`src/services/README.md`](src/services/README.md)
...
**Full SSE patterns and AI streaming**: See [`src/features/ai/README.md`](src/features/ai/README.md)
...
**Full component patterns and accessibility requirements**: See [`src/components/README.md`](src/components/README.md)
...
**Full AI integration patterns and PilotSpaceStore API**: See [`src/features/ai/README.md`](src/features/ai/README.md)
...
| Module       | Doc                                                            | Covers                                             |
| ------------ | -------------------------------------------------------------- | -------------------------------------------------- |
| Features     | [`src/features/README.md`](src/features/README.md)             | Feature modules, folder structure, domain overview |
| Stores       | [`src/stores/README.md`](src/stores/README.md)                 | MobX stores, AI stores, state patterns             |
| Notes/Editor | [`src/features/notes/README.md`](src/features/notes/README.md) | TipTap extensions, editor setup, ghost text        |
| AI           | [`src/features/ai/README.md`](src/features/ai/README.md)       | AI integration, SSE streaming, PilotSpaceStore     |
| Services     | [`src/services/README.md`](src/services/README.md)             | API clients, RFC 7807, query patterns              |
| Components   | [`src/components/README.md`](src/components/README.md)         | Shared UI, shadcn/ui, accessibility                |
