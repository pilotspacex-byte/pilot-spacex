        ...
        headers: [
          {
            ...
            value: [
              ...
              "font-src 'self'",
              `connect-src 'self' https://*.supabase.co wss://*.supabase.co https://cdn.jsdelivr.net${sbOrigin ? ` ${sbOrigin}` : ''}${sbWsOrigin ? ` ${sbWsOrigin}` : ''}${apiOrigin ? ` ${apiOrigin}` : ''}${apiWsOrigin ? ` ${apiWsOrigin}` : ''}`,
