...
import { Lightbulb, AlertTriangle, HelpCircle, Sparkles, Link2 } from 'lucide-react';
...
const typeColors = {
  suggestion: 'bg-blue-50 border-blue-200 text-blue-700 dark:bg-blue-950/30 dark:border-blue-800 dark:text-blue-300',
  warning: 'bg-amber-50 border-amber-200 text-amber-700 dark:bg-amber-950/30 dark:border-amber-800 dark:text-amber-300',
  question: 'bg-purple-50 border-purple-200 text-purple-700 dark:bg-purple-950/30 dark:border-purple-800 dark:text-purple-300',
  insight: 'bg-green-50 border-green-200 text-green-700 dark:bg-green-950/30 dark:border-green-800 dark:text-green-300',
  reference: 'bg-gray-50 border-gray-200 text-gray-700 dark:bg-gray-900/30 dark:border-gray-700 dark:text-gray-300',
};
...
export function AnnotationCard({
  ...
  return (
    <button
      ...
      aria-label={`${annotation.type}: ${annotation.title}`}
    ...
    >
      ...
      <div className="flex items-center justify-between mt-2">
        <span className="text-xs opacity-60 capitalize font-medium">
          {annotation.type}
        </span>
        <span
