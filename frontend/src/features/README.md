...
| Module        | Purpose                                            | Docs                                         |
| ------------- | -------------------------------------------------- | -------------------------------------------- |
| **Notes**     | Block-based editor, ghost text, issue extraction   | [`notes/README.md`](notes/README.md)         |
| **Issues**    | Issue CRUD, AI context, activity tracking          | [`issues/README.md`](issues/README.md)       |
| **AI**        | Conversational interface, SSE streaming, approvals | [`ai/README.md`](ai/README.md)               |
| **Approvals** | Human-in-the-loop workflow (DD-003)                | [`approvals/README.md`](approvals/README.md) |
| **Cycles**    | Sprint management, burndown charts                 | [`cycles/README.md`](cycles/README.md)       |
| **Homepage**  | Landing page (Note-First), activity feed, digest   | [`homepage/README.md`](homepage/README.md)   |

### Integration Modules

| Module           | Purpose                               | Docs                                   |
| ---------------- | ------------------------------------- | -------------------------------------- |
| **GitHub**       | PR review, linking, OAuth             | [`github/README.md`](github/README.md) |
...
| Module       | Purpose                                           | Docs                                       |
| ------------ | ------------------------------------------------- | ------------------------------------------ |
| **Settings** | Workspace, members, AI providers, profile, skills | [`settings/README.md`](settings/README.md) |
| **Costs**    | AI cost tracking by agent/user/day                | [`costs/README.md`](costs/README.md)       |
