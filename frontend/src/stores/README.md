...
| Module              | Doc                                        | Covers                                                                |
| ------------------- | ------------------------------------------ | --------------------------------------------------------------------- |
| **AI Stores** (11)  | [`ai/README.md`](ai/README.md)             | PilotSpaceStore, GhostTextStore, ApprovalStore, AIContextStore, etc.  |
| **Core Stores** (7) | [`features/README.md`](features/README.md) | AuthStore, UIStore, WorkspaceStore, NoteStore, IssueStore, CycleStore |
...
- **AI Stores (detailed)**: [`ai/README.md`](ai/README.md)
- **Core Stores (detailed)**: [`features/README.md`](features/README.md)
