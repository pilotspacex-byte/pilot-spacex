...
| Module                | Doc                                    | Covers                                              |
| --------------------- | -------------------------------------- | --------------------------------------------------- |
| **Editor Components** | [`editor/README.md`](editor/README.md) | NoteCanvas, 13 TipTap extensions, auto-save, layout |
...
- **Editor Components**: [`editor/README.md`](editor/README.md)
